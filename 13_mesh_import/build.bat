...
set LIBS=%LIB_PATH_GLFW% %LIB_PATH_GLEW% %LIB_PATH_ASSIMP% glew32.lib glfw3dll.lib OpenGL32.lib %SYSTEM_LIBS%
...
cl %CFLAGS% %SRC% %INCLUDES% /link %LFLAGS% %LIBS% /OUT:"debugshdrs.exe" 
