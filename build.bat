...
set SYSTEM_LIBS= /DYNAMICBASE "kernel32.lib" "user32.lib" "gdi32.lib" "winspool.lib" "comdlg32.lib" "advapi32.lib" "shell32.lib" "ole32.lib" "oleaut32.lib" "uuid.lib" "odbc32.lib" "odbccp32.lib" /DEBUG /MACHINE:X64 /INCREMENTAL 
...
FOR %%A IN (%DIR_LIST%) DO (
  ...
  echo cl %SRC% %INCLUDES% /link %LIBS% /OUT:"main.exe" 
  cl %SRC% %INCLUDES% /link %LIBS% /OUT:"main.exe" 
  copy ..\%DLL_PATH_GLEW% .\
  copy ..\%DLL_PATH_GLFW% .\
  cd ..
)
